...
class DocumentLogPrinter {
    ...
    private fun createLogFile(document: Document) : File {
        File(taskTrackerFolderPath).mkdirs()
        ...
        val logFile = File("$taskTrackerFolderPath/${trackedFile?.nameWithoutExtension}_${trackedFile.hashCode()}_${document.hashCode()}_$logFilesNumber.csv")
